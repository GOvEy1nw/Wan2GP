...
def preview_media_to_html(media: PreviewMedia, *, height: int = 200) -> str:
    ...
    media_html = f'<video src="{uri}" autoplay loop muted playsinline style="max-height:100%;max-width:100%;object-fit:contain"></video>' if media.media_kind == "video" else f'<img src="{uri}" style="max-height:100%;max-width:100%;object-fit:contain" alt="Live Tiny VAE generation preview">'
